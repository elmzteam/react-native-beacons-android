...
public class BeaconsAndroidModule extends ReactContextBaseJavaModule implements BeaconConsumer {
	...
	@ReactMethod
	public void startAdvertising(String regionId, String uuid, int major, int minor, Callback resolve, Callback reject) {
		if (mBeaconTransmitter != null) {
			reject.invoke("You can't transmit multiple beacons at the same time.");
		}
	...
	@ReactMethod
	public void stopAdvertising(Callback resolve, Callback reject) {
		if (mBeaconTransmitter == null) {
			reject.invoke("You can't stop advertising before you start.");
		}
